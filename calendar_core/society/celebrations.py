...
def build_celebrations_events(year: int) -> list[CalendarEvent]:
    ...
    events.extend([
        ...
        CalendarEvent("Festival de Cannes — Ouverture", date(year, 5, 14), categories=["Culture", "Cinéma"], description="Le Festival International du Film de Cannes, créé en 1946."),
